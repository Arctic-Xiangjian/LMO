...
def main():
    ...
    # ------------------------------------------------------------------------------------------------------------------
    # save models and results in save_path
    ...
    dummy = torch.empty(int(10 * 1024**3 // 4), dtype=torch.float32).to(device)

    # ------------------------------------------------------------------------------------------------------------------
    if args.train == 'train':
        # --------------------------------------------------------------------------------------------------------------
        # save training data in train and val folder for visualization
        ...
        # --------------------------------------------------------------------------------------------------------------
        # ground_truth, rec_image, under_sample
        ...
        for epoch in range(start_epoch + 1, args.n_epochs + 1):
            ...
            # valid
            valid_loss, psnr, ssim, nrmse = validate(valid_loader, model, loss, epoch, output_writers, device, logger, args)
